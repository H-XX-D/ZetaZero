...
//
// Persistence Model:
//   - Session-scoped by default (RAM only)
//   - Optional disk persistence for session resume
//   - Unified IDs link to GitGraph nodes when persisted
// =============================================================================

// Edge metadata - use canonical definition from branching engine
using BranchEdge = zeta_branching::EdgeMeta;

// =============================================================================
// BRANCH GRAPH - Use canonical definition from branching engine
// Research mode extends this with SemanticLayer in BranchGraphExtended
// =============================================================================

using BranchGraph = zeta_branching::BranchGraph;

// Research-specific alias for edge metadata
using BranchEdgeResearch = zeta_branching::EdgeMeta;
