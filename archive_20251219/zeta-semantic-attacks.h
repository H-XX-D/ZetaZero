...
static bool zeta_attack_init_anchors() {
    ...
    float type_thresholds[ATTACK_COUNT] = {
        0.0f,   // NONE
        0.58f,  // IDENTITY_OVERRIDE - fairly strict
        0.55f,  // EMOTIONAL_MANIPULATION - more lenient for edge cases
        0.60f,  // AUTHORITY_CLAIM - strict
        0.52f,  // GASLIGHTING - lower threshold to catch subtle cases
        0.58f,  // JAILBREAK
        0.62f,  // INJECTION - very strict, less false positives
        0.50f,  // EXISTENTIAL - catch more philosophy-based attacks
        0.55f   // META_MANIPULATION
    };
