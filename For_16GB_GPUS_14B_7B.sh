...
MODELS_DIR="${MODELS_DIR:-$HOME/models/zetazero-14b-7b}"
...
LOG_FILE="$ROOT/zeta_server_14b_7b.log"
...
nohup python3 -m http.server "$PORT_UI" --directory "$UI_DIR" >"$ROOT/zeta_ui_14b_7b.log" 2>&1 &
UI_PID=$!
